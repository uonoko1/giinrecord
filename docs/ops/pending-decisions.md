...
**これが決まるまで止まっているもの**: **未実装 9 県の ETL 実装。**
**調査は 9 県すべて完了済み**（`docs/research/local-assemblies.md`）:

```
青森・秋田・群馬・大分・沖縄   #529/#615/#616/#617/#619（2026-09-07）
熊本                          #671（2026-09-09。「総数のみ」と書いていたのが誤りだった）
山梨・滋賀・佐賀              #670（2026-09-09。「不明」と書いていたのが誤りだった）
```

**2026-09-09 に 5 県 → 9 県に増えました。**
**増えた 4 県は「公開していない」と書かれていたのが誤りで、
熊本は個人票が 60 本以上の PDF リンクの 1 本に埋もれており、
山梨・滋賀・佐賀は入口の見つけ方だけの問題でした。**

**「送る」と決めた場合、宛先が最大 16 県になります**（実装済み 7 ＋ 未実装 9）。
**一度に全部送るか、実装する順に送るかも決める必要があります。**
