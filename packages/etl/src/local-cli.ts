 ...
 *   **N の既定は議会ごと**（`defaultSessionsFor`。#901）——**秋田 29 / 滋賀 19 / 青森 14 / 佐賀 13 / 宮城 11 / 鳥取 11 / 高知 5 / 島根 5 / 三重 4 / 徳島 4 / 奈良 4。**
...
// **`--sessions` が無ければ議会ごとの既定**（#901。秋田 29、滋賀 19、青森 14、佐賀 13、宮城・鳥取 11、高知・島根 5、三重・徳島・奈良 4）
