 ...
 *   **N の既定は議会ごと**（`defaultSessionsFor`。#901）——**秋田 29 / 青森 14 / 宮城 11 / 高知 5 / 三重 4 / 徳島 4 / 奈良 4 / 他の 4 議会 2。**
...
// **`--sessions` が無ければ議会ごとの既定**（#901。秋田は 29、青森は 14、宮城は 11、高知は 5、三重・徳島・奈良は 4、他の 4 議会は 2）
