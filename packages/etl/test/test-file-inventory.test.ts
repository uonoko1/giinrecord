...
const ETL_TEST_FILES_MIN = 158; // 実測 2026-09-20: readdirSync で 161（− 3。#720 の規則）。#928 が 156 → 157、**#901 が local-sessions-default.test.ts と local-cli-sessions.test.ts を足して 157 → 159、さらに 高知の kochi-petition-branch.test.ts と kochi-widened-anchors.test.ts を足して 159 → 161**。**139 のままだと 18 本消しても落ちなかった**（#720 が詰めた「実数から離れたぶんだけ守っていない」がまた開いていた）
