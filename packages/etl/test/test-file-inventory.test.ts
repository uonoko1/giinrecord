...
const ETL_TEST_FILES_MIN = 154; // 実測 2026-09-20: readdirSync で 157（− 3。#720 の規則）。#928 が local-roster-window.test.ts を足して 156 → 157。**139 のままだと 18 本消しても落ちなかった**（#720 が詰めた「実数から離れたぶんだけ守っていない」がまた開いていた）
