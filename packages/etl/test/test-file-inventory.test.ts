...
const WEB_TEST_FILES_MIN = 85; // 実測 2026-09-07: walk() で 85
const ETL_TEST_FILES_MIN = 84; // 実測 2026-09-07: readdirSync で 84（このファイル自身を含む）
const CI_TEST_FILES_MIN = 6; // 実測 2026-09-07: readdirSync で 6
