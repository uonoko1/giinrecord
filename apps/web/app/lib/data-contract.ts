 ...
 */
import type { Assembly, AssemblyId, AssemblyKind, DatasetMeta, DatasetSource, DietAssemblyId, LocalAssemblyMeta, House, LocalVote, Member, MemberId, RollCall, RollCallSummary, SourceHouse, SourceKind, VoteValue } from "@seiji-kiroku/shared";

export type { Assembly, AssemblyId, AssemblyKind, DatasetMeta, DatasetSource, DietAssemblyId, LocalAssemblyMeta, LocalVote, RollCall, RollCallSummary, SourceHouse, SourceKind, VoteValue };
