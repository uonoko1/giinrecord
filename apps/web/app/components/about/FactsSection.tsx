...
const FACTS = [
  ...
  {
    kind: "事実",
    title: "法案の提出者・賛成者、本会議と委員会の発言",
    body: "衆参の議案情報と国会会議録検索システムより。発言は本会議に加えて委員会（分科会・審査会・連合審査会・公聴会・調査会を含む）も収録し、会議名は会議録の原文のまま出します。要約せず、原文へのリンクと冒頭の抜粋のみ。",
  },
  {
    // #358: 地方議会は「議員ごとの表決が公表されている議会」だけを収録している（#128 の調査）。
    // 公表されていない議会は収録していないので、地方の表決は推定を挟まない＝事実の側。
    kind: "事実",
    title: "地方議会の表決",
    body: "各議会が公表している「議員ごとの表決」の一次資料（多くは PDF）から転記。議員ごとの賛否が公表されている議会だけを収録しています。会議名・議案名は原文のまま出します。",
  },
  {
    kind: "推定",
    title: "衆議院の賛否",
